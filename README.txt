...
Jin:	We should work in resolving the issues with whitespaces. It has to do with not considering that the string is empty (Resolved)
		...
		Also, there is a bug where it does not recognise default libraries (Resolved).
		There is a bug where the program does not recognise user-defined libraries (unresolved)
